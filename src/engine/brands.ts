...
const PROFILES: Record<string, BrandProfile> = {
  'intesa-sanpaolo': mk('intesa-sanpaolo', {
    ...
    success: '#258900',
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.55, tracking: -0.3, card: 'shadow', rows: 'rule', avatar: 'round', cta: 'stack', ctaPlace: 'stick', ctaInset: 0, ctaSize: 'md', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  unicredit: mk('unicredit', {
    ...
    radius: 8, font: IBM,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.45, tracking: 0, card: 'plain', rows: 'rule', avatar: 'none', cta: 'one', ctaPlace: 'flush', ctaInset: 0, ctaSize: 'sm', ctaSecondary: 'none', density: 'tight', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  fineco: mk('fineco', {
    logoBg: '#fff', logoPad: 3, logoRadius: 6, preferDark: false,
    ...
    radius: 8, font: IBM,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.35, tracking: 0, card: 'plain', rows: 'stack', avatar: 'none', cta: 'one', ctaPlace: 'raised', ctaInset: 12, ctaSize: 'md', ctaSecondary: 'none', density: 'tight', hairline: false, brandInHeader: true, pill: false, weight: 650 },
  }),
  chase: mk('chase', {
    ...
    radius: 8,
    ui: { chrome: 'toolbar', hero: 'amount', amountAlign: 'start', amountEm: 2.05, tracking: -0.8, card: 'none', rows: 'space', avatar: 'none', cta: 'one', ctaPlace: 'stick', ctaInset: 4, ctaSize: 'lg', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: true, pill: false, weight: 700 },
  }),
  'bank-of-america': mk('bank-of-america', {
    ...
    radius: 6,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.5, tracking: -0.2, card: 'border', rows: 'rule', avatar: 'none', cta: 'stack', ctaPlace: 'flush', ctaInset: 8, ctaSize: 'sm', ctaSecondary: 'text', density: 'tight', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  'wells-fargo': mk('wells-fargo', {
    ...
    radius: 8,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'center', amountEm: 1.7, tracking: -0.4, card: 'shadow', rows: 'rule', avatar: 'round', cta: 'split', ctaPlace: 'stick', ctaInset: 6, ctaSize: 'md', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 800 },
  }),
  revolut: mk('revolut', {
    ...
    ui: { chrome: 'bare', hero: 'person', amountAlign: 'center', amountEm: 2.35, tracking: -1.4, card: 'none', rows: 'space', avatar: 'circle', cta: 'one', ctaPlace: 'raised', ctaInset: 20, ctaSize: 'lg', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 600 },
  }),
  n26: mk('n26', {
    ...
    ui: { chrome: 'minimal', hero: 'person', amountAlign: 'center', amountEm: 2.1, tracking: 0.2, card: 'none', rows: 'space', avatar: 'circle', cta: 'one', ctaPlace: 'follow', ctaInset: 8, ctaSize: 'md', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: false, weight: 500, details: 'min' },
  }),
  'deutsche-bank': mk('deutsche-bank', {
    ...
    radius: 2, font: IBM,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.3, tracking: 0, card: 'border', rows: 'rule', avatar: 'none', cta: 'stack', ctaPlace: 'raised', ctaInset: 0, ctaSize: 'sm', ctaSecondary: 'ghost', density: 'tight', hairline: true, brandInHeader: true, pill: false, weight: 600 },
  }),
  commerzbank: mk('commerzbank', {
    ...
    radius: 4, font: IBM,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.4, tracking: 0, card: 'border', rows: 'rule', avatar: 'none', cta: 'split', ctaPlace: 'flush', ctaInset: 0, ctaSize: 'md', ctaSecondary: 'ghost', density: 'tight', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  'bnp-paribas': mk('bnp-paribas', {
    ...
    success: '#00915A',
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'center', amountEm: 1.65, tracking: -0.4, card: 'shadow', rows: 'rule', avatar: 'round', cta: 'one', ctaPlace: 'stick', ctaInset: 16, ctaSize: 'md', ctaSecondary: 'none', density: 'normal', hairline: true, brandInHeader: true, pill: true, weight: 700 },
  }),
  'societe-generale': mk('societe-generale', {
    ...
    radius: 4,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.4, tracking: 0, card: 'plain', rows: 'stack', avatar: 'none', cta: 'stack', ctaPlace: 'stick', ctaInset: 22, ctaSize: 'md', ctaSecondary: 'text', density: 'tight', hairline: false, brandInHeader: true, pill: false, weight: 700 },
  }),
  bcr: mk('bcr', {
    logoBg: '#fff', logoPad: 3, logoRadius: 8, preferDark: false,
    bg: '#F4F6F8', surface: '#fff', text: '#003366', muted: '#5C6B7A', line: '#D8DEE6',
    accent: '#E2001A', button: '#003366', buttonText: '#fff',
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.5, tracking: -0.2, card: 'border', rows: 'rule', avatar: 'round', cta: 'stack', ctaPlace: 'stick', ctaInset: 10, ctaSize: 'lg', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  brd: mk('brd', {
    logoBg: '#fff', logoPad: 3, logoRadius: 8, preferDark: false,
    bg: '#F7F4F5', surface: '#fff', text: '#1A1A1A', muted: '#6B5C60', line: '#E6DCE0',
    accent: '#CC092F', button: '#CC092F', buttonText: '#fff',
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'center', amountEm: 1.6, tracking: -0.3, card: 'shadow', rows: 'rule', avatar: 'round', cta: 'split', ctaPlace: 'raised', ctaInset: 8, ctaSize: 'sm', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 800 },
  }),
  barclays: mk('barclays', {
    ...
    ui: { chrome: 'toolbar', hero: 'amount', amountAlign: 'start', amountEm: 1.95, tracking: -0.7, card: 'none', rows: 'space', avatar: 'none', cta: 'one', ctaPlace: 'raised', ctaInset: 2, ctaSize: 'lg', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: true, pill: false, weight: 700 },
  }),
  hsbc: mk('hsbc', {
    ...
    radius: 6,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.45, tracking: 0, card: 'border', rows: 'rule', avatar: 'none', cta: 'stack', ctaPlace: 'flush', ctaInset: 4, ctaSize: 'md', ctaSecondary: 'ghost', density: 'tight', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  santander: mk('santander', {
    ...
    ui: { chrome: 'minimal', hero: 'person', amountAlign: 'center', amountEm: 1.9, tracking: -0.5, card: 'shadow', rows: 'rule', avatar: 'circle', cta: 'stack', ctaPlace: 'raised', ctaInset: 18, ctaSize: 'md', ctaSecondary: 'text', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 800 },
  }),
  bbva: mk('bbva', {
    ...
    radius: 8, font: DM,
    ui: { chrome: 'toolbar', hero: 'amount', amountAlign: 'start', amountEm: 1.85, tracking: -0.6, card: 'none', rows: 'stack', avatar: 'none', cta: 'one', ctaPlace: 'follow', ctaInset: 0, ctaSize: 'lg', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: true, pill: false, weight: 700 },
  }),
  ubs: mk('ubs', {
    ...
    radius: 4, font: IBM,
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.25, tracking: 0.1, card: 'plain', rows: 'rule', avatar: 'none', cta: 'stack', ctaPlace: 'stick', ctaInset: 20, ctaSize: 'sm', ctaSecondary: 'none', density: 'tight', hairline: true, brandInHeader: true, pill: false, weight: 600 },
  }),
  'standard-bank': mk('standard-bank', {
    ...
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.55, tracking: -0.2, card: 'border', rows: 'rule', avatar: 'round', cta: 'stack', ctaPlace: 'raised', ctaInset: 14, ctaSize: 'md', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  ecobank: mk('ecobank', {
    logoBg: '#fff', logoPad: 3, logoRadius: 8, preferDark: false,
    bg: '#F3F6F8', surface: '#fff', text: '#003B5C', muted: '#5C7080', line: '#D4E0E6',
    accent: '#00A651', button: '#003B5C', buttonText: '#fff',
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'center', amountEm: 1.6, tracking: -0.3, card: 'shadow', rows: 'rule', avatar: 'round', cta: 'split', ctaPlace: 'stick', ctaInset: 10, ctaSize: 'lg', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  paypal: mk('paypal', {
    ...
    ui: { chrome: 'bare', hero: 'person', amountAlign: 'center', amountEm: 2.2, tracking: -0.6, card: 'none', rows: 'stack', avatar: 'check', cta: 'one', ctaPlace: 'raised', ctaInset: 16, ctaSize: 'lg', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 600, details: 'lite' },
  }),
  'apple-pay': mk('apple-pay', {
    ...
    ui: { chrome: 'bare', hero: 'amount', amountAlign: 'center', amountEm: 2.55, tracking: -1.6, card: 'none', rows: 'space', avatar: 'none', cta: 'one', ctaPlace: 'stick', ctaInset: 28, ctaSize: 'sm', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 600 },
  }),
  'google-pay': mk('google-pay', {
    ...
    ui: { chrome: 'minimal', hero: 'person', amountAlign: 'start', amountEm: 1.7, tracking: 0, card: 'none', rows: 'stack', avatar: 'circle', cta: 'split', ctaPlace: 'raised', ctaInset: 12, ctaSize: 'md', ctaSecondary: 'ghost', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 500 },
  }),
  venmo: mk('venmo', {
    ...
    ui: { chrome: 'bare', hero: 'person', amountAlign: 'center', amountEm: 2.45, tracking: -1.1, card: 'none', rows: 'space', avatar: 'circle', cta: 'split', ctaPlace: 'follow', ctaInset: 22, ctaSize: 'lg', ctaSecondary: 'text', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 800 },
  }),
  'cash-app': mk('cash-app', {
    ...
    ui: { chrome: 'bare', hero: 'amount', amountAlign: 'center', amountEm: 2.7, tracking: -1.8, card: 'none', rows: 'space', avatar: 'none', cta: 'one', ctaPlace: 'follow', ctaInset: 28, ctaSize: 'lg', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: false, weight: 700 },
  }),
  wise: mk('wise', {
    ...
    ui: { chrome: 'minimal', hero: 'pair', amountAlign: 'center', amountEm: 2.0, tracking: -0.9, card: 'none', rows: 'space', avatar: 'circle', cta: 'one', ctaPlace: 'stick', ctaInset: 24, ctaSize: 'md', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 800 },
  }),
  'western-union': mk('western-union', {
    ...
    radius: 8,
    ui: { chrome: 'toolbar', hero: 'pair', amountAlign: 'center', amountEm: 1.7, tracking: -0.2, card: 'border', rows: 'rule', avatar: 'round', cta: 'stack', ctaPlace: 'raised', ctaInset: 6, ctaSize: 'lg', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 800 },
  }),
  remitly: mk('remitly', {
    ...
    radius: 14, font: DM,
    ui: { chrome: 'minimal', hero: 'pair', amountAlign: 'center', amountEm: 1.85, tracking: -0.5, card: 'shadow', rows: 'stack', avatar: 'circle', cta: 'stack', ctaPlace: 'follow', ctaInset: 16, ctaSize: 'sm', ctaSecondary: 'text', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 700 },
  }),
  binance: mk('binance', {
    ...
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.55, tracking: 0, card: 'plain', rows: 'rule', avatar: 'none', cta: 'one', ctaPlace: 'flush', ctaInset: 0, ctaSize: 'md', ctaSecondary: 'none', density: 'tight', hairline: false, brandInHeader: true, pill: false, weight: 600 },
  }),
  coinbase: mk('coinbase', {
    ...
    ui: { chrome: 'minimal', hero: 'amount', amountAlign: 'center', amountEm: 2.05, tracking: -1.2, card: 'none', rows: 'stack', avatar: 'circle', cta: 'one', ctaPlace: 'raised', ctaInset: 32, ctaSize: 'sm', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 400, details: 'min' },
  }),
  kraken: mk('kraken', {
    ...
    ui: { chrome: 'toolbar', hero: 'ledger', amountAlign: 'start', amountEm: 1.55, tracking: -0.4, card: 'border', rows: 'space', avatar: 'none', cta: 'one', ctaPlace: 'stick', ctaInset: 8, ctaSize: 'sm', ctaSecondary: 'none', density: 'tight', hairline: false, brandInHeader: true, pill: false, weight: 600 },
  }),
  'crypto-com': mk('crypto-com', {
    ...
    ui: { chrome: 'minimal', hero: 'amount', amountAlign: 'center', amountEm: 2.0, tracking: -0.8, card: 'none', rows: 'space', avatar: 'circle', cta: 'stack', ctaPlace: 'flush', ctaInset: 18, ctaSize: 'lg', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 700 },
  }),
  tim: mk('tim', {
    logoBg: '#0033A0', logoPad: 4, logoRadius: 10, preferDark: false,
    bg: '#F3F5FA', surface: '#fff', text: '#0033A0', muted: '#5C6B8A', line: '#D6DEE8',
    accent: '#E30613', button: '#0033A0', buttonText: '#fff',
    ui: { chrome: 'toolbar', hero: 'operator', amountAlign: 'center', amountEm: 1.6, tracking: -0.2, card: 'border', rows: 'rule', avatar: 'round', cta: 'stack', ctaPlace: 'raised', ctaInset: 10, ctaSize: 'md', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  vodafone: mk('vodafone', {
    ...
    radius: 16, font: MANROPE,
    ui: { chrome: 'minimal', hero: 'operator', amountAlign: 'center', amountEm: 1.85, tracking: -0.5, card: 'shadow', rows: 'rule', avatar: 'circle', cta: 'stack', ctaPlace: 'stick', ctaInset: 14, ctaSize: 'lg', ctaSecondary: 'text', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 800 },
  }),
  orange: mk('orange', {
    ...
    ui: { chrome: 'minimal', hero: 'operator', amountAlign: 'center', amountEm: 1.9, tracking: -0.6, card: 'none', rows: 'stack', avatar: 'round', cta: 'one', ctaPlace: 'follow', ctaInset: 20, ctaSize: 'md', ctaSecondary: 'none', density: 'air', hairline: false, brandInHeader: false, pill: true, weight: 700, details: 'min' },
  }),
  moneygram: mk('moneygram', {
    logoBg: '#DF2127', logoPad: 4, logoRadius: 8, preferDark: false,
    bg: '#F7F4F4', surface: '#fff', text: '#1A1A1A', muted: '#6B5C5C', line: '#E8DEDE',
    accent: '#DF2127', button: '#DF2127', buttonText: '#fff',
    ui: { chrome: 'toolbar', hero: 'code', amountAlign: 'center', amountEm: 1.55, tracking: 0.4, card: 'border', rows: 'rule', avatar: 'round', cta: 'stack', ctaPlace: 'flush', ctaInset: 2, ctaSize: 'lg', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 800 },
  }),
  visa: mk('visa', {
    ...
    radius: 6, font: IBM,
    ui: { chrome: 'toolbar', hero: 'cards', amountAlign: 'start', amountEm: 1.5, tracking: 0.2, card: 'shadow', rows: 'rule', avatar: 'none', cta: 'stack', ctaPlace: 'raised', ctaInset: 8, ctaSize: 'sm', ctaSecondary: 'ghost', density: 'normal', hairline: true, brandInHeader: true, pill: false, weight: 700 },
  }),
  mastercard: mk('mastercard', {
    ...
    ui: { chrome: 'minimal', hero: 'cards', amountAlign: 'center', amountEm: 1.7, tracking: -0.4, card: 'shadow', rows: 'space', avatar: 'circle', cta: 'split', ctaPlace: 'stick', ctaInset: 18, ctaSize: 'sm', ctaSecondary: 'ghost', density: 'normal', hairline: false, brandInHeader: false, pill: true, weight: 700 },
  }),
}
